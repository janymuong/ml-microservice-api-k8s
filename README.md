...
### Helper Scripts:
`make_prediction.sh` `run_docker.sh` `run_kubernetes.sh` `upload_docker.sh` - These are bash scripts that you can use in place of multple/chained shell commands.
